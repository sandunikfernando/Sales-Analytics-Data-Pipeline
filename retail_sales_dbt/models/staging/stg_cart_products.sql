select
    ...
    coalesce(cast(discount_percentage as decimal(10,2)), 0) as discount_percentage,
    cast(discounted_total as decimal(10,2)) as discounted_total,

    case
        when load_timestamp is null then null
        else cast(load_timestamp as varchar)
    end as load_timestamp_raw
